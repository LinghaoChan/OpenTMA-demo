...
class TEMOS(BaseModel):
    ...
    def t2m_eval(self, batch):
        ...
        #     np.save(os.path.join("/comp_robot/lushunlin/motion-latent-diffusion/retrieval/test_motion", '{:0{width}}.npy'.format(self.gt_idx, width=5)), motions[i].detach().cpu().numpy())
        #     with open(os.path.join("/comp_robot/lushunlin/motion-latent-diffusion/retrieval/test_text", '{:0{width}}.txt'.format(self.gt_idx, width=5)), "w") as test_file:
